...
describe("Convert Numbers Into Zeros", function () {
  it("SShould return the elements equal to the position one in zeros and a length of nine", function () {
  ...
  it("Should return the elements equal to the position one in zeros and a length of seven", function () {
